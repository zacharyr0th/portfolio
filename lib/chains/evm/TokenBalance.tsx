...
function TokenBalanceComponent({
    ...
    const chain = 'chainId' in token ? Object.values(EVM_CHAINS).find(c => c.chainId === token.chainId) : null;

    // Check if this is a native token
    const isNativeToken = 'address' in token && token.address === '0x0000000000000000000000000000000000000000';
