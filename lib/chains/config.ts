...
export const chainInfo: Readonly<Record<ChainType, ChainInfo>> = Object.freeze({
    ...
    ethereum: {
        ...
        decimals: 18,
        isTestnet: false,
        rpcEndpoint: getEnvVar('NEXT_PUBLIC_ETH_RPC_URL', 'https://eth.llamarpc.com'),
        features: {
            hasSmartContracts: true,
            hasNFTs: true,
            hasDeFi: true,
    ...
    polygon: {
        ...
        decimals: 18,
        isTestnet: false,
        rpcEndpoint: getEnvVar('NEXT_PUBLIC_POLYGON_RPC_URL', 'https://polygon.llamarpc.com'),
        features: {
            hasSmartContracts: true,
            hasNFTs: true,
            hasDeFi: true,
    ...
    arbitrum: {
        ...
        decimals: 18,
        isTestnet: false,
        rpcEndpoint: getEnvVar('NEXT_PUBLIC_ARBITRUM_RPC_URL', 'https://arb1.arbitrum.io/rpc'),
        features: {
            hasSmartContracts: true,
            hasNFTs: true,
            hasDeFi: true,
    ...
    optimism: {
        ...
        decimals: 18,
        isTestnet: false,
        rpcEndpoint: getEnvVar('NEXT_PUBLIC_OPTIMISM_RPC_URL', 'https://mainnet.optimism.io'),
        features: {
            hasSmartContracts: true,
            hasNFTs: true,
            hasDeFi: true,
    ...
    base: {
        ...
        decimals: 18,
        isTestnet: false,
        rpcEndpoint: getEnvVar('NEXT_PUBLIC_BASE_RPC_URL', 'https://mainnet.base.org'),
        features: {
            hasSmartContracts: true,
            hasNFTs: true,
            hasDeFi: true,
