...
export const NFT_SUPPORTED_CHAINS = {
  ...
  arbitrum_one: SUPPORTED_CHAINS.arbitrum_one,
  ...
  proof_of_play: SUPPORTED_CHAINS.proof_of_play,
  scroll: SUPPORTED_CHAINS.scroll,
  treasure: SUPPORTED_CHAINS.treasure,
  xai: SUPPORTED_CHAINS.xai,
...
export const CHAIN_ADDRESS_TYPE: Record<
  ChainType,
  "evm" | "solana" | "aptos" | "sui" | "bitcoin" | "utxo"
> = {
  // Layer 1s
  ethereum: "evm",
  solana: "solana",
...
export const CHAIN_CONFIG = {
  ...
  moonbeam: {
    ...
    nativeCurrency: { symbol: "GLMR", name: "Moonbeam", decimals: 18 },
    chainId: 1284,
  },
  opbnb: {
    name: "opBNB",
  ...
  b3: {
    name: "B3",
    explorerUrl: "https://explorer.b3.network",
  ...
  godwoken: {
    ...
    nativeCurrency: { symbol: "CKB", name: "Godwoken", decimals: 18 },
    chainId: 1008,
  },
  immutable_zkevm: {
    name: "Immutable zkEVM",
    explorerUrl: "https://explorer.immutable.com",
    nativeCurrency: { symbol: "IMX", name: "Immutable", decimals: 18 },
    chainId: 1009,
  },
  loot: {
    name: "Loot",
    explorerUrl: "https://explorer.lootchain.com",
    nativeCurrency: { symbol: "LOOT", name: "Loot", decimals: 18 },
    chainId: 5151706,
  },
  proof_of_play: {
    name: "Proof of Play",
    explorerUrl: "https://explorer.proofofplay.network",
    nativeCurrency: { symbol: "POP", name: "Proof of Play", decimals: 18 },
    chainId: 70700,
  },
  proof_of_play_boss: {
    name: "Proof of Play Boss",
    explorerUrl: "https://explorer.proofofplay.boss",
    nativeCurrency: {
      symbol: "BOSS",
      name: "Proof of Play Boss",
      decimals: 18,
  ...
  soneium: {
    name: "Soneium",
    explorerUrl: "https://explorer.soneium.com",
  ...
  saakuru: {
    ...
    nativeCurrency: { symbol: "SAAK", name: "Saakuru", decimals: 18 },
    chainId: 1006,
  },
  palm: {
    name: "Palm",
  ...
  treasure: {
    name: "Treasure",
    explorerUrl: "https://explorer.treasure.lol",
    nativeCurrency: { symbol: "MAGIC", name: "Treasure", decimals: 18 },
    chainId: 1002,
  },
  xai: {
    name: "Xai",
    explorerUrl: "https://explorer.xai.games",
