...
export const exchangeHandlers: Partial<
  Record<SupportedExchange, ExchangeHandler>
> = {
...
export const isSupportedExchange = (
  exchange: string,
): exchange is SupportedExchange => exchange in exchangeHandlers;
