...
export type CexPlatform = Extract<
  PlatformType,
...
export type BankAccountWithPlatform = PlatformAccount<
  BankAccount,
  BankPlatform
>;
export type BrokerAccountWithPlatform = PlatformAccount<
  BrokerAccount,
  BrokerPlatform
>;
export type CexAccountWithPlatform = PlatformAccount<CexAccount, CexPlatform>;
export type CreditAccountWithPlatform = PlatformAccount<
  CreditAccount,
  CreditPlatform
>;
export type DebitAccountWithPlatform = PlatformAccount<
  DebitAccount,
  DebitPlatform
>;
