...
const getDisplayName = (symbol: string, address?: string, name?: string, chainType?: string) => {
    // Native ETH
...
const getExplorerUrl = (symbol: string, address?: string, chainType?: string) => {
...
const getDecimalPrecision = (symbol: string, quantity: number, value: number, chainType?: string) => {
...
function TokenBalanceComponent({
    ...
    const value = useMemo(() => price ? quantity * price : 0, [price, quantity])

    // Move all hooks before any conditional returns
    const isBlacklisted = useMemo(() => 
        token.address === '0x3c1d4a86594d681ff7e5d5a233965daeabdc6a15fe5672ceeda5260038857183::vcoins::V<0x111ae3e5bc816a5e63c2da97d0aa3886519e0cd5e4b046659fa35796bd11542a::stapt_token::StakedApt>',
        [token.address]
    )
    ...
    const { min, max } = useMemo(() => 
        getDecimalPrecision(token.symbol.toUpperCase(), quantity, value, chainType),
