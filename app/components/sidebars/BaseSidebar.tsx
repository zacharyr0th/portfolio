...
interface SidebarFooterSeparatorProps
  extends React.HTMLAttributes<HTMLDivElement> {
  children: React.ReactNode;
}
  ...
  const cardClasses = useMemo(
    () =>
      cn(
        ...
        isMobile
          ? "fixed top-0 bottom-0 bg-background/90 backdrop-blur-md"
          : "bg-inherit",
        isMobile && "border-0",
      ),
    [isLeft, isMobile],
...
export const SidebarFooterContent = React.forwardRef<
  HTMLDivElement,
  SidebarFooterContentProps
>(({ className, ...props }, ref) => (
  <div
...
export const SidebarFooterSeparator = React.forwardRef<
  HTMLDivElement,
  SidebarFooterSeparatorProps
>(({ className, ...props }, ref) => (
...
export const SidebarFooterActions = React.forwardRef<
  HTMLDivElement,
  SidebarFooterActionsProps
>(({ className, ...props }, ref) => (
  <div
...
export const SidebarFooterButton = React.forwardRef<
  HTMLButtonElement,
  SidebarFooterButtonProps
>(({ className, ...props }, ref) => {
  return (
...
export const SidebarFooterLink = React.forwardRef<
  HTMLAnchorElement,
  SidebarFooterLinkProps
>(({ className, ...props }, ref) => {
  return (
